...
with spcm.Card('/dev/spcm0', verbose=True) as card:                         # if you want to open a specific card
    ...
    trigger_modes_families = {
        ...
        3:  [0x22, 0x23, 0x44, 0x59],
        4:  [0x22, 0x23, 0x44, 0x59],
        5:  [0x22, 0x23, 0x44, 0x59],
        6:  [0x22, 0x23, 0x44, 0x59],
        7:  [0x22, 0x23, 0x44, 0x59],
        8:  [0x22, 0x23, 0x44, 0x59],
        9:  [0x22, 0x23, 0x44, 0x59],
        10: [0x22, 0x23, 0x44, 0x59]
    }
